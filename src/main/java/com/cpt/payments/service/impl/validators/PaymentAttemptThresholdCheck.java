...
private MerchantPaymentRequestDao merchantPaymentRequestDao;
	...
	public void validate(PaymentRequestDTO paymentRequestDTO) {
		...
		log.info("Payment attempts in last {} minutes: {} | endUserId:{}", 
				durationInMins, count, paymentRequestDTO.getUser().getEndUserID());
		...
		log.info("PaymentAttemtpsthresholdCheck passed for endUserId: {}",
